...
public final class ServiceChargeGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.price.Price.hospitalprice,
      com.proto.price.Price.service_price> getGetPriceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "get_price",
      requestType = com.proto.price.Price.hospitalprice.class,
      responseType = com.proto.price.Price.service_price.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.proto.price.Price.hospitalprice,
      com.proto.price.Price.service_price> getGetPriceMethod() {
    io.grpc.MethodDescriptor<com.proto.price.Price.hospitalprice, com.proto.price.Price.service_price> getGetPriceMethod;
      ...
      synchronized (ServiceChargeGrpc.class) {
        if ((getGetPriceMethod = ServiceChargeGrpc.getGetPriceMethod) == null) {
          ServiceChargeGrpc.getGetPriceMethod = getGetPriceMethod = 
              io.grpc.MethodDescriptor.<com.proto.price.Price.hospitalprice, com.proto.price.Price.service_price>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "ServiceCharge", "get_price"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.price.Price.hospitalprice.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.price.Price.service_price.getDefaultInstance()))
  ...
  public static abstract class ServiceChargeImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getPrice(com.proto.price.Price.hospitalprice request,
        io.grpc.stub.StreamObserver<com.proto.price.Price.service_price> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.proto.price.Price.hospitalprice,
                com.proto.price.Price.service_price>(
  ...
  public static final class ServiceChargeBlockingStub extends io.grpc.stub.AbstractStub<ServiceChargeBlockingStub> {
     ...
     * </pre>
     */
    public com.proto.price.Price.service_price getPrice(com.proto.price.Price.hospitalprice request) {
  ...
  public static final class ServiceChargeFutureStub extends io.grpc.stub.AbstractStub<ServiceChargeFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.price.Price.service_price> getPrice(
        com.proto.price.Price.hospitalprice request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRICE:
          serviceImpl.getPrice((com.proto.price.Price.hospitalprice) request,
              (io.grpc.stub.StreamObserver<com.proto.price.Price.service_price>) responseObserver);
          break;
        default:
  ...
  private static abstract class ServiceChargeBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.proto.price.Price.getDescriptor();
    }
